...
- 84 columns: 5 flow identifiers + 79 flow features — directly usable as ML feature input
...
**Memory per flow:** 800 bytes for `FlowRecord`. At 100,000 concurrent flows: ~80 MB.

---

## Feature List (legacy 44-column subset; the exporter now emits 84 columns / 79 features)
